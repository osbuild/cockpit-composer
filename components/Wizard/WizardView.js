...
class WizardView extends React.Component {
  ...
  componentDidMount() {
    let wizard = new Wizard('#complete');
  }
        ...
        <div className="modal-dialog modal-lg wizard-pf">
          <div className="modal-content">
            <div className="modal-header">
              <button type="button" className="close wizard-pf-dismiss" aria-label="Close" onClick={this.handleClose}><span
            ...
            <div className="modal-footer wizard-pf-footer">
              <button type="button" className="btn btn-default btn-cancel wizard-pf-cancel wizard-pf-dismiss" onClick={this.handleClose}>Cancel</button>
              ...
              <button type="button" className="btn btn-primary hidden wizard-pf-close wizard-pf-dismiss" onClick={this.handleClose}>Close</button>
