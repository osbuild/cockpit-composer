...
// -----------------------------------------------------------------------------
tasks.set("clean", () =>
  del(["public/dist/*", "!public/dist/.git", "public/po.*.js", "build/localeLoader.js"], { dot: true })
);
...
`;
    ...
    pofiles.forEach(filename => {
      ...
      exec(`node ./po/po2json -m ./po/po.empty.js -o public/po.${language}.js ${filename}`, err => {
        if (err !== null) {
...
tasks.set("build", () => {
  ...
  exec("git describe --always", (error, stdout) => {
