  ...
  render() {
    return (
      <Layout className="container-fluid container-pf-nav-pf-vertical">
				...
				<ol className="breadcrumb"><li><Link to="/recipes">Back to Recipes</Link></li><li className="active"><a href="#"><strong>Low Latency</strong></a></li></ol>
            ...
            <form className="toolbar-pf-actions">
              ...
              <div className="form-group">
                <button className="btn btn-default" type="button">Edit Recipe</button>
								<button className="btn btn-default" type="button">Create Composition</button>
